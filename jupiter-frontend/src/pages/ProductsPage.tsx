...
export const ProductsPage: React.FC = () => {
  ...
  const initialCategory = searchParams.get('category') || 'fly-ash-brick-machine';
  ...
  const filteredProducts = (products || []).filter(p => {
        ...
        if (targetSlug === 'machine-spares') {
          return pCat.includes('spare') || pSlug.includes('spare');
        }
  ...
  return (
    <div className="products-page-view">
            ...
            {categories.map(cat => {
              ...
              return (
                <button
                  key={cat.id}
                  onClick={() => {
                    if (cat.slug === 'machine-spares' || cat.id === 'machine-spares') {
      ...
      {/* Bottom CTA Banner */}
      <section className="products-bottom-cta-banner">
        <div className="container">
          <div className="products-cta-flex-container">
            ...
            <div className="products-cta-left-box">
              ...
              <p className="products-cta-subtitle">
                Our experts are here to guide you with the best solution for your production goals.
              </p>
            </div>
            ...
            <div className="products-cta-right-box">
              ...
              <div className="products-cta-stamp">
                <div>MACHINERY</div>
                <div>PEOPLE</div>
                <div>PROGRESS</div>
              </div>
