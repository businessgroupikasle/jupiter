...
export const MachineCategoryPage: React.FC = () => {
  ...
  const handleQuoteSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name.trim() || !formData.phone.trim()) {
      setStatusMessage({ type: 'error', text: 'Please provide your name and contact phone number.' });
      return;
    }
    ...
    try {
      await submitEnquiry({
        name: formData.name,
        email: formData.email || 'customer@inquiry.com',
          ...
          <div className="products-cta-flex-container">
            <div className="products-cta-left-box">
              ...
              <p className="products-cta-subtitle">
                Our Coimbatore factory engineers are ready to assist you with custom plant planning and turnkey setup.
              </p>
            </div>
        ...
        <div className="modal-backdrop-overlay" onClick={() => setQuoteModalOpen(false)}>
          <div className="modal-content-card" style={{ maxWidth: '520px' }} onClick={e => e.stopPropagation()}>
            <div className="modal-header-bar">
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 800, color: '#00233D' }}>
