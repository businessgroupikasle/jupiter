...
const MANUFACTURING_STEPS = [
  {
    ...
    shortDesc: 'High-tensile structural steel plates and forged shafts.',
    fullDesc: 'We source prime certified IS 2062 Grade steel plates and alloy shafts. Ultrasonic testing is conducted on all raw structural billets to eliminate micro-cracks before fabrication.',
    icon: Layers,
    badge: 'STAGE 01 • MATERIAL INTEGRITY',
    image: 'https://images.unsplash.com/photo-1504917599217-d4dc5ebe6122?auto=format&fit=crop&w=800&q=80',
    specLabel1: 'Material Grade',
    specVal1: 'IS 2062 E250 / E350',
    specLabel2: 'Inspection',
    specVal2: '100% Ultrasonic Tested'
  },
  {
    step: '02',
    title: 'CNC Machining',
    shortDesc: 'Laser profile cutting and precision milling of mould dies.',
    fullDesc: 'High-precision CNC vertical machining centers cut and heat-treat heavy alloy steel moulds, ensuring razor-sharp dimensional accuracy within ±0.05 mm tolerance.',
    icon: Wrench,
    badge: 'STAGE 02 • PRECISION CNC DIES',
    image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80',
    specLabel1: 'Mould Tolerance',
    specVal1: '±0.05 mm Micro-Precision',
    specLabel2: 'Heat Treatment',
    specVal2: '58 - 62 HRC Hardness'
  },
  {
    step: '03',
    title: 'Hydraulic Assembly',
    shortDesc: 'High-tonnage cylinders & vibration synchronizer assembly.',
    fullDesc: 'Heavy-duty hydraulic power packs, hard-chromed honed cylinders, and synchronized high-frequency vibration tables are integrated to produce 30 to 100 Tons of uniform compaction force.',
    icon: Gauge,
    badge: 'STAGE 03 • HYDRAULIC POWER PACK',
    image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=800&q=80',
    specLabel1: 'Compaction Pressure',
    specVal1: '30 - 100 Tons Force',
    specLabel2: 'Hydraulic Valves',
    specVal2: 'European Proportional'
  },
  {
    step: '04',
    title: 'PLC Programming',
    shortDesc: 'Touchscreen controls and automated recipe calibration.',
    fullDesc: 'Intelligent Schneider / Siemens PLC automation panels with touchscreen HMI are programmed with recipe memory, cycle timer sync, and real-time remote diagnostics.',
    icon: Cpu,
    badge: 'STAGE 04 • SMART AUTOMATION',
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=800&q=80',
    specLabel1: 'Control System',
    specVal1: 'Touchscreen PLC HMI',
    specLabel2: 'Automation Level',
    specVal2: 'Fully / Semi-Automatic'
  },
  {
    step: '05',
    title: '48-Hr Quality Run',
    shortDesc: 'Continuous load testing and high pressure verification.',
    fullDesc: 'Every finished machinery unit undergoes a strict 48-hour continuous non-stop factory dry & wet test run. Oil temperature, vibration frequency, and pressure stability are certified.',
    icon: Award,
    badge: 'STAGE 05 • ZERO-DEFECT QUALITY RUN',
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80',
    specLabel1: 'Testing Duration',
    specVal1: '48 Hours Continuous Run',
    specLabel2: 'Quality Standard',
    specVal2: 'ISO 9001:2015 Verified'
  },
  {
    step: '06',
    title: 'On-Site Commissioning',
    shortDesc: 'Turnkey plant setup and operator training on your site.',
    fullDesc: 'Senior Jupiter field engineers arrive on your plant site for full foundation alignment, electrical commissioning, trial brick production, and comprehensive operator training.',
    icon: Factory,
    badge: 'STAGE 06 • TURNKEY SITE SETUP',
    image: 'https://images.unsplash.com/photo-1584463699026-6f81c9676e10?auto=format&fit=crop&w=800&q=80',
    specLabel1: 'Service Scope',
    specVal1: 'Pan-India Installation',
    specLabel2: 'Warranty Coverage',
    specVal2: '1-Year Onsite Guarantee'
  }
];

export const AboutPage: React.FC = () => {
  // Active Interactive Step state (0 to 5)
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setActiveStepIdx((prev) => (prev + 1) % MANUFACTURING_STEPS.length);
    }, 4500);

    return () => clearInterval(interval);
  }, [isAutoPlaying]);

  const currentStep = MANUFACTURING_STEPS[activeStepIdx];

  const handlePrevStep = () => {
    setIsAutoPlaying(false);
    setActiveStepIdx((prev) => (prev === 0 ? MANUFACTURING_STEPS.length - 1 : prev - 1));
  };
  ...
  return (
    <div className="about-page-view acme-style-about-page">
      ...
      <section className="about-intro-section">
        <div className="container">
          <div className="about-intro-grid image-on-left">
            ...
            <div className="about-intro-visual-col">
      ...
      {/* =====================================================================
          3. SECTION 2: "STEP BY STEP TOWARDS PERFECTION" (ANIMATED & INTERACTIVE)
          ===================================================================== */}
      <section className="about-process-section animated-process-section">
        <div className="container">
          <div className="about-section-header text-center">
            ...
            <p className="about-process-subtitle">
              From raw alloy steel procurement to precision testing, our 6-stage engineering process ensures zero defects.
            </p>
          </div>

          {/* Animated Connecting Timeline Bar */}
          <div className="interactive-timeline-container">
            {/* Glowing animated connection track */}
            <div className="timeline-connecting-track">
              <div
                className="timeline-progress-fill"
                style={{ width: `${(activeStepIdx / (MANUFACTURING_STEPS.length - 1)) * 100}%` }}
              ></div>
            </div>

            {/* 6 Circular Interactive Step Nodes */}
            <div className="about-process-steps-wrapper">
              {MANUFACTURING_STEPS.map((item, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`about-process-step-item ${isActive ? 'active' : ''} ${isPassed ? 'passed' : ''}`}
                    title={`Click to view Stage ${item.step}: ${item.title}`}
                  >
                    {/* Animated Outer Pulse Ring */}
                    <div className="step-circle-badge-wrapper">
                      {isActive && <div className="step-glow-pulse"></div>}
                    ...
                    <h4 className="step-item-title">{item.title}</h4>
                    <p className="step-item-desc">{item.shortDesc}</p>
                  </button>
                );
              })}
            </div>
          ...
          {/* =====================================================================
              DYNAMIC INTERACTIVE SPOTLIGHT CARD (STAGE DEEP-DIVE)
              ===================================================================== */}
          <div className="process-spotlight-card">
            <div className="spotlight-inner-grid">
              {/* Left Column: Stage Info & Technical Specs */}
              <div className="spotlight-text-col">
                ...
                <div className="spotlight-metrics-row">
                  <div className="spotlight-metric-chip">
                    <span className="metric-chip-lbl">{currentStep.specLabel1}</span>
                    <span className="metric-chip-val">{currentStep.specVal1}</span>
                  </div>

                  <div className="spotlight-metric-chip">
                    <span className="metric-chip-lbl">{currentStep.specLabel2}</span>
                    <span className="metric-chip-val text-orange-glow">{currentStep.specVal2}</span>
                  </div>
                </div>

                {/* Interactive Controls Bar */}
                <div className="spotlight-controls-bar">
                  <div className="spotlight-nav-buttons">
                    <button
                      type="button"
                      onClick={handlePrevStep}
                      className="btn-spotlight-nav"
                      title="Previous Step"
                    >
                      <ChevronLeft size={18} />
                      <span>Prev</span>
                    ...
                    <button
                      ...
                      className="btn-spotlight-nav primary"
                      title="Next Step"
                    >
                      <span>Next Step</span>
                  ...
                  <button
                    ...
                    className={`btn-autoplay-toggle ${isAutoPlaying ? 'playing' : ''}`}
                    title={isAutoPlaying ? 'Pause Auto-Play' : 'Start Auto-Play'}
                  >
                    {isAutoPlaying ? <Pause size={14} /> : <Play size={14} />}
                    <span>{isAutoPlaying ? 'Auto-Cycle ON' : 'Paused'}</span>
                  </button>
                </div>
              </div>

              {/* Right Column: Live Production Photo with Ambient Glow */}
              <div className="spotlight-media-col">
                <div className="spotlight-image-container">
                  <div className="spotlight-ambient-glow"></div>
                  <img
                    key={currentStep.step}
                    src={currentStep.image}
                    alt={currentStep.title}
                    className="spotlight-hero-img spotlight-image-fade"
                    loading="lazy"
                  />
                  <div className="spotlight-floating-step-badge">
                    <span>STAGE {currentStep.step} / 06</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* =====================================================================
          4. SECTION 3: "OUR MISSION & VISION" (2-COLUMN MATCHING REFERENCE)
          ===================================================================== */}
      ...
      {/* =====================================================================
          6. SECTION 5: BOTTOM CONSULTATION CTA BANNER
          ===================================================================== */}
      <section className="products-bottom-cta-banner about-bottom-cta">
        <div className="container">
          <div className="products-cta-flex-container">
            <div className="products-cta-left-box">
              <div className="products-cta-dash"></div>
              <h2 className="products-cta-title">
                Need Help Planning Your Manufacturing Plant?
              </h2>
              <p className="products-cta-subtitle">
                Speak directly with our senior machinery engineers for custom plant layout, project reports, and quotations.
              </p>
            </div>

            <div className="products-cta-right-box">
              <Link
                to="/contact"
